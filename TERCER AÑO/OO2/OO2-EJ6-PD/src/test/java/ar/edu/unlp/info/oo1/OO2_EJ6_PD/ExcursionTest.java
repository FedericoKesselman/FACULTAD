...
public class ExcursionTest {
    ...
    void testExcursionProvisorioInscribir() {
        ...
        assertTrue(excursionProvisorio.getState() instanceof StateProvisoria);
        
        excursionProvisorio.inscribir(user2);
        assertTrue(excursionProvisorio.getState() instanceof StateProvisoria);
        
        excursionProvisorio.inscribir(user3);
        assertTrue(excursionProvisorio.getState() instanceof StateDefinitiva);
    }
    ...
    void testExcursionDefinitivoObtenerInformacion() {
        String cadena = "Nombre: Ruta del Vino\n" +
                       ...
                       "Mails inscriptos: ana.gomez@email.com\n" +
                       "carlos.lopez@email.com\n" +
                       "sofia.martinez@email.com\n" +
                       "Faltantes cupo maximo: 1";
    ...
    void testExcursionDefinitivoInscribir() {
        assertTrue(excursionDefinitivo.getState() instanceof StateDefinitiva);
        
        excursionDefinitivo.inscribir(user4);
        assertTrue(excursionDefinitivo.getState() instanceof StateLlena);
    }
    ...
    void testExcursionCompletaInscribir() {
        assertTrue(excursionCompleta.getState() instanceof StateLlena);
        
        excursionCompleta.inscribir(user1);
        assertEquals(1, excursionCompleta.getListaEspera().size());
    }
}
