...
public class Ejercicio8 {
    ...
    public boolean esPrefijo (BinaryTree<Integer> arbol1, BinaryTree<Integer> arbol2) {
        if (!arbol1.isEmpty() && !arbol2.isEmpty())
            return esP(arbol1, arbol2);
        else
            return false;
    }

    public boolean esP (BinaryTree<Integer> arbol1, BinaryTree<Integer> arbol2) {
        ...
        if (arbol1.getData() != (arbol2.getData())) 
            ...
            if (arbol1.hasLeftChild() && arbol2.hasLeftChild()) 
                ok1 = esP (arbol1.getLeftChild(), arbol2.getLeftChild());
            else {
                if (arbol1.hasLeftChild() && !arbol2.hasLeftChild()) 
                    ok1 = false;
            }
            ...
            if (arbol1.hasRightChild() && arbol2.hasRightChild())
                ok2 = esP (arbol1.getRightChild(), arbol2.getRightChild());
            else {
                if (arbol1.hasRightChild() && !arbol2.hasRightChild()) 
                    ok2 = false;
            }        
    ...
    public static void main (String[] args) {
        ...
        Ejercicio8 parcialArboles = new Ejercicio8();
