...
public class Caminos {
	...
	public List<Integer> caminoAHojaMasLejana () {
		...
		if (!arbol.isEmpty()) {
			caminoHelper(arbol, lista, new LinkedList<>());
		}
		
		return lista;
	}
	
	private void caminoHelper (GeneralTree<Integer> nodo, List<Integer> caminoMax, List<Integer> caminoAct) {
		...
		if (!nodo.hasChildren()) {
			...
			for (GeneralTree<Integer> child: nodo.getChildren())
				caminoHelper (child, caminoMax, caminoAct);
		}
